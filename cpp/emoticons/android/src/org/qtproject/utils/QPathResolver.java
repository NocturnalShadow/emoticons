...
// slightly modified by ekke@ekkes-corner.org 2017
// slightly modified by NocturnalShadow 2019
    ...
    public static String getRealPathFromURI(Context context, String uriString) {
        ...
        if (isKitKat && DocumentsContract.isDocumentUri(context, uri)) {
            ...
            if (isExternalStorageDocument(uri)) {
                Log.d("QPathResolver"," isExternalStorageDocument");
            ...
            // DownloadsProvider
                ...
                Log.d("QPathResolver"," isDownloadsDocument");
                final String id = DocumentsContract.getDocumentId(uri);
                Log.d("QPathResolver"," getDocumentId "+id);
                long longId = 0;
                try
                  {
            ...
            // MediaProvider
                ...
                Log.d("QPathResolver"," isMediaDocument");
                final String docId = DocumentsContract.getDocumentId(uri);
                final String[] split = docId.split(":");
                final String type = split[0];
                ...
                Log.d("QPathResolver"," is uri.getScheme()");
            ...
            // Other Providers
                ...
                Log.d("QPathResolver ","is Other Provider");
                try {
        ...
        // MediaStore (and general)
            ...
            Log.d("QPathResolver ","NOT DocumentsContract.isDocumentUri");
            Log.d("QPathResolver"," is uri.getScheme()");
            // Return the remote address
            if (isGooglePhotosUri(uri))
                return uri.getLastPathSegment();
            Log.d("QPathResolver"," return: getDataColumn ");
            return getDataColumn(context, uri, null, null);
        }
        // File
        else if ("file".equalsIgnoreCase(uri.getScheme())) {
            Log.d("QPathResolver ","NOT DocumentsContract.isDocumentUri");
            Log.d("QPathResolver"," is file scheme");
            return uri.getPath();
        }
